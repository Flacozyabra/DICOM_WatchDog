...
"""
Скрипт для сборки автономного Windows-клиента (.exe) DICOM WatchDog с PyQt5.
"""
...
def check_and_install_dependencies():
    ...
    try:
        import PyQt5
        print("[OK] PyQt5 уже установлен.")
    except ImportError:
        print("[INFO] PyQt5 не найден. Запуск установки для сборки PyQt5-версии...")
...
def build_executable(has_icon):
    ...
    args = [
        ...
        "--name=DICOM_WatchDog_v1.4.1_PyQt5",
    ...
    print("[OK] Компиляция .exe на PyQt5 успешно завершена.")
