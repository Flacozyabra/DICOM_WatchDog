...
from PyQt6.QtCore import Qt, QTimer, QSize, QRect, QPoint, QPropertyAnimation, pyqtProperty
from PyQt6.QtGui import QColor, QAction, QIcon, QFont, QPainter, QBrush, QPen
