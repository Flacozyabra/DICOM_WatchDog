...
- **`DICOM_WatchDog_v1.4.1_PyQt6.exe`** (Recommended for Modern Windows 10/11)
...
- **`DICOM_WatchDog_v1.4.1_PyQt5.exe`** (Windows 10/11 Compatible)
...
- **`DICOM_WatchDog_v1.4.1_PyQt5_Legacy.exe`** (Windows 7/8/10 Legacy)
...
- **`DICOM_WatchDog_v1.4.1_PyQt6.exe`** (Рекомендуется для современной Windows 10/11)
...
- **`DICOM_WatchDog_v1.4.1_PyQt5.exe`** (Windows 10/11 Совместимая)
...
- **`DICOM_WatchDog_v1.4.1_PyQt5_Legacy.exe`** (Легаси Windows 7/8/10)
